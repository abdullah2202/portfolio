    ...
    <section className="hero" aria-label="Intro">
      <Container className="heroGrid">
        <div className="heroCopy">
          <p className="heroEyebrow">Abdullah — DevOps Engineer</p>
          <p className="pill">AWS • Terraform • CI/CD • GitHub Actions</p>
        ...
        <aside className="heroCard">
          <div className="card">
            ...
            <ul className="list">
              ...
              <li><span className="dot"></span> GitHub Actions deploys on push + CloudFront invalidation</li>
            </ul>
          </div>
        </aside>
      </Container>
